      ...
      <div className="shadow-lg" style={sidebarStyle}>
        <div className="p-2">
          ...
          <div className="d-flex align-items-center mb-4 pb-3 border-bottom border-light border-opacity-25">
            ...
            <div>
              <h5 className="h5 mb-0" style={{ color: 'var(--text-primary)' }}>TimeSheet Pro</h5>
          ...
          <div className="mb-4">
            <div className="input-group">
              <span className="input-group-text border-0" style={{ backgroundColor: 'var(--border-color)', color: 'var(--text-secondary)' }}>
              ...
              <input
                ...
                onFocus={(e) => e.target.style.backgroundColor = 'var(--secondary-bg)'}
                onBlur={(e) => e.target.style.backgroundColor = 'var(--border-color)'}
              />
            </div>
          </div>
          ...
          <ul className="nav nav-pills flex-column">
            <li className="nav-item mb-1">
              <a className="nav-link d-flex align-items-center py-3 px-3 rounded"
                style={{
                  backgroundColor: currentView === 'dashboard' ? 'var(--border-color)' : 'transparent',
                  transition: 'all 0.3s ease',
                  cursor: 'pointer',
                  color: 'var(--text-primary)'
                }}
                onMouseEnter={(e) => currentView !== 'dashboard' && (e.currentTarget.style.backgroundColor = 'var(--border-color)')}
                onMouseLeave={(e) => currentView !== 'dashboard' && (e.currentTarget.style.backgroundColor = 'transparent')}
                onClick={() => setCurrentView('dashboard')}>
                <i className="fas fa-home me-3" style={{ width: '20px', color: 'var(--text-primary)' }}></i>
                <span>Dashboard</span>
              </a>
            </li>
            <li className="nav-item mb-1">
            ...
            <li className="nav-item mb-1">
              <a className="nav-link d-flex align-items-center py-3 px-3 rounded"
                style={{
                  backgroundColor: currentView === 'clients' ? 'var(--border-color)' : 'transparent',
                  transition: 'all 0.3s ease',
                  cursor: 'pointer',
                  color: 'var(--text-primary)'
                }}
                onMouseEnter={(e) => currentView !== 'clients' && (e.currentTarget.style.backgroundColor = 'var(--border-color)')}
                onMouseLeave={(e) => currentView !== 'clients' && (e.currentTarget.style.backgroundColor = 'transparent')}
                onClick={() => setCurrentView('clients')}>
                <i className="fas fa-building me-3" style={{ width: '20px', color: 'var(--text-primary)' }}></i>
                <span>Clients</span>
              </a>
            </li>
            <li className="nav-item mb-1">
              <a className="nav-link d-flex align-items-center py-3 px-3 rounded"
                style={{
                  backgroundColor: currentView === 'projects' ? 'var(--border-color)' : 'transparent',
                  transition: 'all 0.3s ease',
                  cursor: 'pointer',
                  color: 'var(--text-primary)'
                }}
                onMouseEnter={(e) => currentView !== 'projects' && (e.currentTarget.style.backgroundColor = 'var(--border-color)')}
                onMouseLeave={(e) => currentView !== 'projects' && (e.currentTarget.style.backgroundColor = 'transparent')}
                onClick={() => setCurrentView('projects')}>
                <i className="fas fa-project-diagram me-3" style={{ width: '20px', color: 'var(--text-primary)' }}></i>
                <span>Projects</span>
              </a>
            </li>
            <li className="nav-item mb-1">
              <a className="nav-link d-flex align-items-center py-3 px-3 rounded"
                ...
                href="#">
                <i className="fas fa-clock me-3" style={{ width: '20px', color: 'var(--text-primary)' }}></i>
                <span>Timesheet</span>
              </a>
            </li>
            <li className="nav-item mb-1">
              <a className="nav-link d-flex align-items-center py-3 px-3 rounded"
                ...
                onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}
                href="#">
                <i className="fas fa-calendar-alt me-3" style={{ width: '20px', color: 'var(--text-primary)' }}></i>
                <span>Leave Management</span>
              </a>
            </li>
            <li className="nav-item mb-1">
              <a className="nav-link d-flex align-items-center py-3 px-3 rounded position-relative"
                style={{ transition: 'all 0.3s ease', color: 'var(--text-primary)' }}
                onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'var(--border-color)'}
                onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}
                href="#">
                <i className="fas fa-inbox me-3" style={{ width: '20px', color: 'var(--text-primary)' }}></i>
                <span>Inbox</span>
                <span className="badge ms-auto" style={{ backgroundColor: colorTheme.danger, color: 'white' }}>6</span>
              </a>
            </li>
            <li className="nav-item mb-1">
              <a className="nav-link d-flex align-items-center py-3 px-3 rounded"
                ...
                onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}
                href="#">
                <i className="fas fa-users me-3" style={{ width: '20px', color: 'var(--text-primary)' }}></i>
                <span>My Team</span>
              </a>
            </li>
            <li className="nav-item mb-1">
              <a className="nav-link d-flex align-items-center py-3 px-3 rounded"
                ...
                onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}
                href="#">
                <i className="fas fa-chart-bar me-3" style={{ width: '20px', color: 'var(--text-primary)' }}></i>
                <span>Reports</span>
              </a>
            </li>
            <li className="nav-item mb-1">
              <a className="nav-link d-flex align-items-center py-3 px-3 rounded"
                ...
                onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}
                href="#">
                <i className="fas fa-cog me-3" style={{ width: '20px', color: 'var(--text-primary)' }}></i>
                <span>Settings</span>
              </a>
            </li>
          </ul>
          ...
          <div className="container-fluid px-4 py-4">
            ...
            <div className="row g-3 mb-4">
              <div className="col-md-3">
                <div className="kpi-tile" style={{ background: `linear-gradient(135deg, var(--kpi-blue-1), var(--kpi-blue-2))` }}>
                  <div className="d-flex align-items-center">
                    <div className="kpi-icon me-3"><i className="fas fa-clock"></i></div>
                    <div>
                      <p className="kpi-title">Hours Today</p>
                      <p className="kpi-value">{timesheetStatus?.totalHours || '0.0'}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-3">
                <div className="kpi-tile" style={{ background: `linear-gradient(135deg, var(--kpi-cyan-1), var(--kpi-cyan-2))` }}>
                  <div className="d-flex align-items-center">
                    <div className="kpi-icon me-3"><i className="fas fa-calendar-week"></i></div>
                    <div>
              ...
              <div className="col-md-3">
                <div className="kpi-tile" style={{ background: `linear-gradient(135deg, var(--kpi-green-1), var(--kpi-green-2))` }}>
                  <div className="d-flex align-items-center">
                    <div className="kpi-icon me-3"><i className="fas fa-tasks"></i></div>
                    <div>
              ...
              <div className="col-md-3">
                <div className="kpi-tile" style={{ background: `linear-gradient(135deg, var(--kpi-amber-1), var(--kpi-amber-2))` }}>
                  <div className="d-flex align-items-center">
                    <div className="kpi-icon me-3"><i className="fas fa-inbox"></i></div>
                    <div>
                  ...
                  <div className="card-body">
                    <div className="timeline">
                      <div className="d-flex align-items-center mb-3">
                        ...
                        <div className="flex-grow-1">
                          <div className="fw-bold" style={{ color: 'var(--text-primary)' }}>Clocked in</div>
                          <small style={{ color: 'var(--text-secondary)' }}>Today at 9:30 AM</small>
                        </div>
                      </div>
                      <div className="d-flex align-items-center mb-3">
                        <div className="me-3">
                        ...
                        <div className="flex-grow-1">
                          <div className="fw-bold" style={{ color: 'var(--text-primary)' }}>Task completed: Frontend Development</div>
                          <small style={{ color: 'var(--text-secondary)' }}>Yesterday at 5:45 PM</small>
                        </div>
                      </div>
                      <div className="d-flex align-items-center">
                        <div className="me-3">
                        ...
                        <div className="flex-grow-1">
                          <div className="fw-bold" style={{ color: 'var(--text-primary)' }}>Leave request submitted</div>
